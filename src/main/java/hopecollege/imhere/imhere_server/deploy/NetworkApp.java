package hopecollege.imhere.imhere_server.deploy;
...
public class NetworkApp {
  ...
  public static void main(final String[] args) {
    ...
    String applicationName = (String) app.getNode().tryGetContext("environmentName");
    ...
    Stack networkStack = new Stack(app, "NetworkStack", StackProps.builder()
      .stackName(applicationName + "-" + environmentName +  "-Network")
      .env(awsEnvironment)
      .build());
